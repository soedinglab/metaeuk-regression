...
"${METAEUK}" taxtocontig "${RESULTPATH}/tempFolder/latest/contigs" "${RESULTPATH}/preds.fas" "${RESULTPATH}/preds.headersMap.tsv" "${DATAPATH}/swissProtSomeClasses" "${RESULTPATH}/taxRes" "${RESULTPATH}/tmpDir" -s 2 --majority 0.5 --tax-lineage --lca-mode 2
